 ...
 */
public interface IMapDataReceiverApi {
    ...
    */
    void setMapDataReceiverProperties(IMapDataReceiverProperties properties);
    IMapDataReceiverProperties getDataReceiverProperties();
}
